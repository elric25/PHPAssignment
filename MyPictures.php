...
if(!isset($_SESSION['signUp'])) {
    ...
    exit();
        ...
        include("AllFunctions.php"); 
                    $_SESSION["myPicturesDropDown"] = $_POST["myPicturesDropDown"];
                    $_SESSION["myPicturesDescription"] = $_POST["myPicturesDescription"];
                    $_SESSION["myPicturesComments"] = $_POST["myPicturesComments"];
                    $_SESSION["leaveComments"] = $_POST["leaveComments"];
  
               if(isset($_POST["btnClear"])){
                unset($_SESSION["myPicturesDropDown"]);
                unset($_SESSION["myPicturesDescription"]);
                unset($_SESSION["myPicturesComments"]);
                unset($_SESSION["leaveComments"]);
   
            }
        if ($isPostBack){
 
            if(ValidateMyPicturesDropDown($_POST["myPicturesDropDown"])
              &&ValidateMyPicturesDescription($_POST["myPicturesDescription"])
              &&ValidateMyPicturesComments($_POST["myPicturesComments"])
               &&ValidateLeaveComments($_POST["leaveComments"])){
